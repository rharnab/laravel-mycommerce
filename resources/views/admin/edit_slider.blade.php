						...
						<form class="form-horizontal" method="POST" action="{{URL('update.slider')}}"  enctype="multipart/form-data">
						  ...
						  <fieldset>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="span6 typeahead" id="typeahead"  name="slider_name" value="{{$slider_info->slider_name}}"><br>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
							  	<img src="{{url($slider_info->slider_image)}}" alt="" width="200px" height="200px">
