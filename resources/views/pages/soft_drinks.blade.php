...
<div class="w3l_banner_nav_right">
		...
		<?php $all_drinks=DB::table('tbl_product')->where('cat_id',$cat_id)->where('status',1)->limit(4)->get() ?>
					<h6>soft drinks</h6>
								...
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="single.html"><img src="{{url($drink->image)}}" alt=" " class="img-responsive" /></a>
										...
										<a  href="{{url('single/'.$drink->id)}}"   class="btn btn-danger">Add to cart</a>
										</div>
									</div>
								</figure>
							</div>
