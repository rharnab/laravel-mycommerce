                ...
                <div class="col-md-9 w3l_fresh_vegetables_grid_right">
                    <div class="col-md-4 w3l_fresh_vegetables_grid">
                        <div class="w3l_fresh_vegetables_grid1">
                            <img src="{{URL::to('front/images/8.jpg')}}" alt=" " class="img-responsive" />
                        </div>
                    </div>
                    <div class="col-md-4 w3l_fresh_vegetables_grid">
                        <div class="w3l_fresh_vegetables_grid1">
                            <div class="w3l_fresh_vegetables_grid1_rel">
                                <img src="{{URL::to('front/images/7.jpg')}}" alt=" " class="img-responsive" />
                        ...
                        <div class="w3l_fresh_vegetables_grid1_bottom">
                            <img src="{{URL::to('front/images/10.jpg')}}" alt=" " class="img-responsive" />
                    ...
                    <div class="col-md-4 w3l_fresh_vegetables_grid">
                        <div class="w3l_fresh_vegetables_grid1">
                            <img src="{{URL::to('front/images/9.jpg')}}" alt=" " class="img-responsive" />
                        </div>
                        <div class="w3l_fresh_vegetables_grid1_bottom">
